...
import { useTracker } from 'meteor/react-meteor-data'; // Assuming you use Meteor's reactive data system
...
const Landing = () => {
  ...
  return (
    <Container id="landing-page" fluid className="py-3">
      ...
      {!isLoggedIn && (
        <h2 className="pb-3 text-center">Please login to continue!</h2>
      )}
    </Container>
  );
};
